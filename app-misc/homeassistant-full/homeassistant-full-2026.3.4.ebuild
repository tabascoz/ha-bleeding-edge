...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260312.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	amazon_devices? ( ~dev-python/aioamazondevices-13.0.1[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-44.7.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.6.0[${PYTHON_USEDEP}] )
	...
	ohme? ( ~dev-python/ohme-1.7.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.17.1[${PYTHON_USEDEP}] )
	...
	portainer? ( ~dev-python/pyportainer-1.0.32[${PYTHON_USEDEP}] )
	...
	tedee? ( ~dev-python/aiotedee-0.2.27[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-1.0.2[${PYTHON_USEDEP}] ~dev-python/serialx-0.6.2[${PYTHON_USEDEP}] )
