...
RDEPEND="${RDEPEND}
	...
	homekit? ( ~dev-python/HAP-python-4.9.2[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.6.0[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] ~dev-python/homekit-audio-proxy-1.2.1[${PYTHON_USEDEP}]  )
