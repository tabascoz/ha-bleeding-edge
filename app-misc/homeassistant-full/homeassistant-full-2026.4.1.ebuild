...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260325.6[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-9.1.0[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.2.8[${PYTHON_USEDEP}] )
	...
	axis? ( ~dev-python/axis-67[${PYTHON_USEDEP}] )
	...
	bsblan? ( ~dev-python/python-bsblan-5.1.3[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-2.0.1[${PYTHON_USEDEP}] )
	...
	hardware? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.1.3[${PYTHON_USEDEP}] ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] ~dev-python/serialx-0.6.2[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/holidays-0.93[${PYTHON_USEDEP}] ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] )
	...
	homekit? ( ~dev-python/HAP-python-4.9.2[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-2.0.0[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] ~dev-python/homekit-audio-proxy-1.2.1[${PYTHON_USEDEP}]  )
	...
	jvc_projector? ( ~dev-python/pyjvcprojector-2.0.3[${PYTHON_USEDEP}] )
	...
	litterrobot? ( ~dev-python/pylitterbot-2025.2.0[${PYTHON_USEDEP}] )
	...
	lutron? ( ~dev-python/pylutron-0.4.0[${PYTHON_USEDEP}] )
	...
	nintendo_parental? ( ~dev-python/pynintendoauth-1.0.2[${PYTHON_USEDEP}] ~dev-python/pynintendoparental-2.3.3[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.18.0[${PYTHON_USEDEP}] )
	...
	playstation_network? ( ~dev-python/PSNAWP-3.0.1[${PYTHON_USEDEP}]  ~dev-python/pyrate-limiter-4.1.0[${PYTHON_USEDEP}]  )
	...
	tplink_omada? ( ~dev-python/tplink-omada-client-1.5.6[${PYTHON_USEDEP}] )
	...
	tractive? ( ~dev-python/aiotractive-1.0.1[${PYTHON_USEDEP}] )
	...
	velux? ( ~dev-python/pyvlx-0.2.32[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.93[${PYTHON_USEDEP}] )
	...
	yale? ( ~dev-python/yalexs-9.0.1[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.2.8[${PYTHON_USEDEP}] )
	yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.4.3[${PYTHON_USEDEP}] )
	yalexs_ble? ( ~dev-python/yalexs-ble-3.2.8[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.1.3[${PYTHON_USEDEP}] ~dev-python/zha-1.1.1[${PYTHON_USEDEP}] ~dev-python/serialx-0.6.2[${PYTHON_USEDEP}] )
	...
	zinvolt? ( ~dev-python/zinvolt-0.4.1[${PYTHON_USEDEP}] )
