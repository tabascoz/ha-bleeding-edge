...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260325.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	amazon_devices? ( ~dev-python/aioamazondevices-13.3.0[${PYTHON_USEDEP}] )
	...
	lojack? ( ~dev-python/lojack-api-0.7.1[${PYTHON_USEDEP}] )
	...
	pooldose? ( ~dev-python/python-pooldose-0.8.5[${PYTHON_USEDEP}] )
