...
RDEPEND="${RDEPEND}
	...
	bsblan? ( ~dev-python/python-bsblan-5.1.2[${PYTHON_USEDEP}] )
	...
	onedrive? ( ~dev-python/onedrive-personal-sdk-0.1.5[${PYTHON_USEDEP}] )
	onedrive_for_business? ( ~dev-python/onedrive-personal-sdk-0.1.5[${PYTHON_USEDEP}] )
