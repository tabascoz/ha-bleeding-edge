...
DESCRIPTION="Easy, practical library for making terminal apps, by providing an elegant, well-documented interface for Terminals."
HOMEPAGE="
...
RDEPEND="
	...
	<dev-python/jinxed-3[${PYTHON_USEDEP}]
