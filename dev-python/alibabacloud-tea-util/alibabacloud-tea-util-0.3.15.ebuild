...
#SRC_URI="https://files.pythonhosted.org/packages/e9/ee/ea90be94ad781a5055db29556744681fc71190ef444ae53adba45e1be5f3/alibabacloud_tea_util-0.3.15.tar.gz"
...
RDEPEND="
    >=dev-python/alibabacloud-tea-0.3.3[${PYTHON_USEDEP}]
"
DEPEND="${RDEPEND}"
BDEPEND="
